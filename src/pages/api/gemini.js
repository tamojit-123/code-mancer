...
const geminiApiKey = process.env.GEMINI_API_KEY; // Ensure GEMINI_API_KEY is set in .env.local
        ...
        try {
            ...
            try {
                ...
                if(responseText.includes("Summary:")){
                    structuredData.summary = responseText.substring(responseText.indexOf("Summary:") + "Summary:".length).split("\n")[0]
                }
